...
<head>
    <link rel="stylesheet" href="../public/css/materi.css">
    ...
    <script src="../public/js/homepage_script.js"></script>
</head>
...
<body>
    <div id="Sidebar" class="sidebar">
        ...
        <div class="user-disp">
            <img src="../public/images/img-user.png" alt="user avatar">
            <div class="user-info">
                <p>User</p>
                <p>id : xxxxxx</p>
            </div>
    ...
    <div id="main">
        ...
        <div class="Content">
            <h1>Math</h1>
            <h2>Chapter 4 - <span style="color:orange">Energy and Transport</span></h2>
            <div class="isi">
